.. merpy documentation master file, created by
   sphinx-quickstart on Mon Oct 21 14:05:01 2019.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

#################################
Welcome to merpy's documentation!
#################################

This software provides a Python interface with MER - Minimal Entity Recognition.
...
- MER: a Minimal Named-Entity Recognition Tagger and Annotation Server, F. Couto, L. Campos, and A. Lamurias, in BioCreative V.5 Challenge Evaluation, 2017 [https://www.researchgate.net/publication/316545534\_MER\_a\_Minimal\_Named-Entity\_Recognition\_Tagger\_and\_Annotation\_Server]
